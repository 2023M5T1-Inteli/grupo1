 ...
 * A vertex has an id, longitude, latitude, altitude and a list of adjacent
 * edges.
...
public class Vertex {
     ...
     * The annotation @Relationship indicates a relationship between the vertex and
     * the Edge entity.
     * The attribute type specifies the relationship type, while direction specifies
    ...
    /**
     * 
     * Constructs a new vertex with the given longitude, latitude, altitude and
     * adjacent edges.
     * 
     * @param longitude the longitude of the vertex.
     * @param latitude  the latitude of the vertex.
    ...
    public String toString() {
        return "Vertex (id: " + this.id + ", lat: " + this.latitude + ", lon: " + this.longitude + ", alt: "
                + this.altitude
                + ")";
