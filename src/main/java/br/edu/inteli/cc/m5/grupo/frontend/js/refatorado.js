...
const postGraph = async () => {
    ...
    console.log(minLat.value);
    console.log(minLong.value);
    console.log(maxLat.value);
    console.log(maxLong.value);
...
const createSvg = (data) => {
    ...
    .append("line")
        ...
        .attr("y2",function(d) {return d.adjacents.length != 0? d.adjacents[0].latitude*scale*-1 + translateY: data[data.length -2].latitude*scale*-1 + translateY})
        .attr("x2",function(d) {return d.adjacents.length != 0? d.adjacents[0].longitude*scale + translateX: data[data.length -2].longitude*scale + translateX})
    ...
    .append("circle")
        ...
        .attr("cx",function(d) {return d.longitude*scale + translateX})
