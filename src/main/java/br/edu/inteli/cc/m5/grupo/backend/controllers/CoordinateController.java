...
public class CoordinateController { 
    ...
    public Coordinate setAllAdjacentCoordinates(@PathVariable Long id, @RequestBody Map<String, List<Long>> adjacentIds) {
        // Encontra a coordenada pelo ID
        Coordinate coordinate = listCoordinateById(id);
    
        List<Long> ids = adjacentIds.get("adjacentCoordinatesIds");
