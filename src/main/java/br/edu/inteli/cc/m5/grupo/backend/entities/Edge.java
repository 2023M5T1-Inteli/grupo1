 ...
 * 
 * This class represents an edge in a graph, connecting two vertices.
 * An Edge is defined by a start and end Vertex, and has a weight determined by
 * the distance between the vertices and their altitude variation.
 */
...
public class Edge {
     ...
     * The weight of the Edge is determined by the distance between the vertices and
     * their altitude variation.
     * 
